...
class MockWorkersRepository implements WorkersRepository {
  final List<Worker> _mockWorkers = [
    Worker(id: 'w1', name: 'Raju K.', profileImageUrl: '', rating: 4.8, reviewsCount: 120, skillIds: ['1'], location: 'Kochi', trustScore: 95),
    Worker(id: 'w2', name: 'Manoj P.', profileImageUrl: '', rating: 4.5, reviewsCount: 85, skillIds: ['1', '4'], location: 'Ernakulam', trustScore: 88),
    Worker(id: 'w3', name: 'Suresh B.', profileImageUrl: '', rating: 4.9, reviewsCount: 200, skillIds: ['5'], location: 'Thrissur', trustScore: 98),
  ];
