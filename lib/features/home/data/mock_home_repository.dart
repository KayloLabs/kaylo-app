...
class MockHomeRepository implements HomeRepository {
  final List<ServiceItem> _mockServices = [
    ...
    ServiceItem(id: '10', name: 'Carpentry', category: 'home', description: 'Furniture repair, assembly, and woodwork', iconPath: 'assets_kaylo/3d_transparent/icon_more.png', basePrice: 450),
    ServiceItem(id: '11', name: 'Painting', category: 'home', description: 'Interior and exterior home painting', iconPath: 'assets_kaylo/3d_transparent/icon_more.png', basePrice: 800),
    ServiceItem(id: '12', name: 'AC Service', category: 'home', description: 'AC maintenance, repair, and gas refilling', iconPath: 'assets_kaylo/3d_transparent/icon_more.png', basePrice: 650),
    ServiceItem(id: '13', name: 'Appliance Repair', category: 'home', description: 'Washing machine, fridge, and TV repair', iconPath: 'assets_kaylo/3d_transparent/icon_more.png', basePrice: 500),
  ];
