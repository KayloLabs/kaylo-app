  ...
  final Map<String, List<WorkerReview>> _mockReviews = {
    'w1': [
      WorkerReview(
        ...
        rating: 5.0,
        comment:
            'Punctual, polite and very skilled. Fixed our bathroom leakage in 30 mins.',
      ...
      WorkerReview(
        ...
        rating: 4.5,
        comment: 'Great service. Arrived on time with all required tools.',
      ...
      WorkerReview(
        ...
        rating: 5.0,
        comment:
            'Highly recommended for any plumbing or coconut tree climbing work!',
    ...
    'w2': [
      ...
      WorkerReview(
        id: 'r5',
        workerId: 'w2',
        customerName: 'Mohanan K.',
        rating: 4.0,
        comment: 'Job done properly, very polite person.',
    ...
    'w3': [
      WorkerReview(
        id: 'r6',
        workerId: 'w3',
        customerName: 'Dr. Radhakrishnan',
        rating: 5.0,
        comment:
            'Outstanding electrician. Solved a complex short circuit issue promptly.',
    ...
    return _mockReviews[workerId] ??
        [
          WorkerReview(
            ...
            rating: 5.0,
            comment:
                'Very professional and reliable service. Highly recommended!',
          ...
          WorkerReview(
            ...
            rating: 4.5,
            comment: 'Good quality work done on time.',
