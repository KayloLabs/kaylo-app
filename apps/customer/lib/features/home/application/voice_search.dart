...
const Map<String, List<_Term>> _intents = {
  'plumb': [
    ...
    _Term('pipe', _strong),
    _Term('tap', _strong),
    _Term('faucet', _strong),
    _Term('leak', _strong),
    _Term('drip', _strong),
    _Term('sink', _strong),
    _Term('toilet', _strong),
    _Term('flush', _strong),
    _Term('drain', _strong),
    _Term('blocked', _strong),
    _Term('പ്ലംബ', _strong),
    _Term('പൈപ്പ്', _strong),
    _Term('ടാപ്പ്', _strong),
    _Term('ചോർച്ച', _strong),
    _Term('ചോര', _strong),
    _Term('ക്ലോസറ്റ്', _strong),
    _Term('பிளம்ப', _strong),
    _Term('குழாய்', _strong),
    _Term('கசிவு', _strong),
    _Term('ஒழுகு', _strong),
    _Term('प्लंब', _strong),
    _Term('नल', _strong),
    ...
    _Term('नाली', _strong),
    _Term('water', _weak),
    _Term('bathroom', _weak),
    _Term('വെള്ളം', _weak),
    _Term('കുളിമുറി', _weak),
    _Term('தண்ணீர்', _weak),
    _Term('குளியலறை', _weak),
    _Term('पानी', _weak),
    _Term('बाथरूम', _weak),
  ],
  'electric': [
    _Term('electric', _strong),
    _Term('wiring', _strong),
    _Term('wire', _strong),
    _Term('socket', _strong),
    _Term('switch', _strong),
    _Term('fan', _strong),
    _Term('bulb', _strong),
    _Term('tube', _strong),
    _Term('light', _strong),
    _Term('power', _strong),
    _Term('current', _strong),
    _Term('shock', _strong),
    _Term('fuse', _strong),
    _Term('വൈദ്യുത', _strong),
    _Term('കറന്റ്', _strong),
    _Term('ഫാൻ', _strong),
    _Term('ബൾബ്', _strong),
    _Term('സ്വിച്ച്', _strong),
    _Term('ലൈറ്റ്', _strong),
    _Term('மின்', _strong),
    _Term('விசிறி', _strong),
    _Term('பல்பு', _strong),
    _Term('சுவிட்ச்', _strong),
    _Term('பவர்', _strong),
    _Term('கரண்ட்', _strong),
    _Term('बिजली', _strong),
    _Term('पंखा', _strong),
    _Term('बल्ब', _strong),
    _Term('लाइट', _strong),
  ...
  'coconut': [
    _Term('coconut', _strong),
    _Term('climber', _strong),
    _Term('pluck', _strong),
    _Term('തേങ്ങ', _strong),
    _Term('തെങ്ങ', _strong),
    _Term('தேங்காய்', _strong),
    _Term('தென்னை', _strong),
  ...
  'arecanut': [
    _Term('arecanut', _strong),
    _Term('areca', _strong),
    _Term('betel', _strong),
    _Term('അടയ്ക്ക', _strong),
    _Term('കവുങ്ങ', _strong),
    _Term('பாக்கு', _strong),
    _Term('கமுகு', _strong),
    _Term('सुपारी', _strong),
  ],
  'garden': [
    _Term('garden', _strong),
    _Term('lawn', _strong),
    _Term('grass', _strong),
    _Term('weeds', _strong),
    _Term('hedge', _strong),
    _Term('mow', _strong),
    _Term('തോട്ടം', _strong),
    _Term('പുല്ല്', _strong),
    _Term('ചെടി', _strong),
    _Term('தோட்டம்', _strong),
    _Term('புல்', _strong),
    _Term('செடி', _strong),
    _Term('களை', _strong),
    _Term('बगीच', _strong),
  ...
  'clean': [
    ...
    _Term('dust', _strong),
    _Term('dirty', _strong),
    _Term('വൃത്തി', _strong),
    _Term('ക്ലീൻ', _strong),
    _Term('തുടയ്ക്ക', _strong),
    _Term('சுத்தம்', _strong),
    _Term('சுத்த', _strong),
    _Term('துடை', _strong),
    _Term('सफाई', _strong),
    _Term('झाड़ू', _strong),
  ...
  'caregiver': [
    _Term('caregiver', _strong),
    _Term('carer', _strong),
    _Term('nurse', _strong),
    _Term('nursing', _strong),
    _Term('പരിചരണ', _strong),
    _Term('നഴ്സ്', _strong),
    _Term('ശുശ്രൂഷ', _strong),
    _Term('பராமரிப்', _strong),
    _Term('செவிலி', _strong),
    _Term('கவனிப்', _strong),
    _Term('देखभाल', _strong),
    _Term('नर्स', _strong),
    _Term('mother', _weak),
    _Term('father', _weak),
    _Term('grandmother', _weak),
    _Term('grandfather', _weak),
    _Term('elderly', _weak),
    _Term('അമ്മ', _weak),
    _Term('അച്ഛൻ', _weak),
    _Term('അമ്മൂമ്മ', _weak),
  ...
  'medicine': [
    _Term('medicine', _strong),
    _Term('tablet', _strong),
    _Term('pills', _strong),
    _Term('dose', _strong),
    _Term('pharmacy', _strong),
    _Term('മരുന്ന', _strong),
    _Term('ഗുളിക', _strong),
    _Term('மருந்த', _strong),
    _Term('மாத்திரை', _strong),
    _Term('दवा', _strong),
    _Term('गोली', _strong),
  ],
};
  ...
  for (final service in pool) {
    ...
    _intents.forEach((family, terms) {
      ...
      for (final term in terms) {
        final hit =
            text.contains(term.text.toLowerCase()) ||
...
bool _fuzzyMatch(String token, String term) {
  ...
  final minLen = tokenRunes.length < termRunes.length
      ? tokenRunes.length
      : termRunes.length;
